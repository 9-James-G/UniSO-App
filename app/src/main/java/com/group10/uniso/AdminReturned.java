...
public class AdminReturned extends AppCompatActivity {
    RecyclerView recyclerView;
    DatabaseReference database;
    MyAdapterRR myAdapter;
    ArrayList<Returned> list2;
    FirebaseAuth fAuth;
    FirebaseUser user;
    DatabaseReference dbReturned,dbReference;
    String userID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_returned);
        ...
        user=fAuth.getCurrentUser();
        list2 = new ArrayList<>();
        myAdapter = new MyAdapterRR(this,list2);
        recyclerView.setAdapter(myAdapter);
        dbReturned = FirebaseDatabase.getInstance().getReference("Returned");
        Query pen_query = FirebaseDatabase.getInstance().getReference("Returned");
...
//            list1.clear();
            if (dataSnapshot.exists()) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Returned returnedDB = snapshot.getValue(Returned.class);
                    list2.add(returnedDB);
                ...
                list2.clear();
                Toast.makeText(AdminReturned.this, "Nothing to see here.", Toast.LENGTH_SHORT).show();
                myAdapter.notifyDataSetChanged();
            }
        }
            ...
            public void onClick(View v) {
                ...
                user.updatePassword(newPass).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(AdminReturned.this, "Changed successfully!", Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(AdminReturned.this, "An Error Occurred!" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
    ...
    public void ClickLogout(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(AdminReturned.this);
...
//                dbReference.child(userID).updateChildren(map);
                ...
                Toast.makeText(AdminReturned.this, "Logged out Successfully!", Toast.LENGTH_SHORT).show();
                finishAffinity();
            }});
    ...
    public void FAB(View view) {
        MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(AdminReturned.this);
        builder.setTitle("WARNING!");
        builder.setMessage("This action will remove all the data of who returned their requested item(s).");
        builder.setIcon(R.drawable.ic_baseline_warning_24);
        builder.setPositiveButton("PROCEED", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dbReturned.removeValue();
                recreate();
            }
        });
